...
//! Project version number for ckafkalib.
FOUNDATION_EXPORT double ckafkalibVersionNumber;

//! Project version string for ckafkalib.
FOUNDATION_EXPORT const unsigned char ckafkalibVersionString[];
